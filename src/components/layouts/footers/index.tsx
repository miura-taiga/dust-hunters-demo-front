...
const XIcon = (props: any) => (
  <SvgIcon {...props} viewBox="0 0 512 512" style={{ width: '50px', height: '38px', color: 'white' }}>
...
const Footer: React.FC = () => {
  return (
    <AppBar position="static" className="bg-gray-800">
      <Toolbar
        sx={{
          minHeight: '150px', // 高さを少し大きく
          justifyContent: 'center',
          flexDirection: 'column',
          paddingTop: '30px', // 上方向の余白
          paddingBottom: '60px', // 下方向の余白
        }}
      >
        ...
        <Box
          sx={{
            display: 'flex',
            flexDirection: { xs: 'column', md: 'row' }, // 小さい画面では縦並び、大きい画面では横並び
            justifyContent: 'center',
            alignItems: 'center',
            mb: 4,
            gap: { xs: 2, md: 8 }, // 画面サイズに応じて間隔を変える
          }}
        >
          <Link
            href="#"
            underline="hover" // ラインを追加
